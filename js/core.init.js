...
function kingler_template_ready_actions() {
	...
	kingler_template_init_sfmenu('header .menu_main_nav_area ul.menu_main_nav, header ul.menu_user_nav, ul#menu_side, body:not(.woocommerce) .widget_area:not(.footer_wrap) .widget_product_categories ul.product-categories');
